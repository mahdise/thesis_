...
def preprocess_data(data_path, save_data=True):
    ...
    if save_data:
        final_data_frame.to_csv(
            r'/home/mahdiislam/Mahdi/Biba/iris-parcel-orientation-detection/Evalouation/processed_data_field_test/' + csv_name,
...
def preprocess_data_with_gt(data_path, save_data=True):
    ...
    encode_angle_type["angle_gt_1"] = [61]*len(encode_angle_type)
    encode_angle_type["box_number_gt_1"] = [1]*len(encode_angle_type)
    encode_angle_type["arrow_direction_gt_1"] = [0]*len(encode_angle_type)
    encode_angle_type["arrow_position_gt_1"] = [0]*len(encode_angle_type)
    encode_angle_type["orientation_type_gt_1"] = [0]*len(encode_angle_type)
    encode_angle_type["angle_type_gt_1"] = [4]*len(encode_angle_type)
    #
    # encode_angle_type["angle_gt_2"] = [140]*len(encode_angle_type)
    ...
    # encode_angle_type["angle_type_type_gt_2"] = [3]*len(encode_angle_type)
    # #
...
if __name__ == '__main__':
    test_data = "/home/mahdiislam/Mahdi/Biba/iris-parcel-orientation-detection/DataTest/FieldTest/RawData/0011.csv"
