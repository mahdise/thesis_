...
ab_bar_list = [plt.bar([0, 1, 2, 3], df.B, align='edge', width= 0.2, label="men"),
               plt.bar([0, 1, 2, 3], df.A, align='edge', width= 0.2, label="vvvmen")]

cd_bar_list = [plt.bar([0, 1, 2, 3], df.D, align='edge',width= -0.2, label="ggggmen"),
               plt.bar([0, 1, 2, 3], df.C, align='edge',width= -0.2, label="vvvvmen")]
