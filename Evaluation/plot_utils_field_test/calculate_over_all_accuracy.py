...
data_of_position = read_data(
    "/Evaluation/statistical_data_field_test/latest_experiment_arroe_pos.csv")

data_of_direction = read_data(
    "/Evaluation/statistical_data_field_test/latest_experiment_arroe_dir.csv")

data_of_angle = read_data(
    "/Evaluation/statistical_data_field_test/latest_experiment_angle.csv")

data_of_box_detect = read_data(
    "/Evaluation/statistical_data_field_test/latest_experiment_top_cam.csv")
