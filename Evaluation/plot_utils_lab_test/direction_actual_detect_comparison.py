...
rect_2 = [
    ax.bar(x + width / 2, final_data_dict["right_ac"],
           width, color="#008080", edgecolor="black", label='actual Right'),
...
# legend = plt.legend(loc='upper right', edgecolor="black", ncol = len(ax.patches))
